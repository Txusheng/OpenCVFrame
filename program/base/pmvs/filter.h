...
class Cfilter {
 ...
 protected:
  ...
  void filterWrongView(void);
  void filterWrongViewThread(void);
  static int filterWrongViewThreadTmp(void* arg);
  //清空深度图，然后多线程设置深度图
